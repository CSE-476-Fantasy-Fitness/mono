        ...
        for (Map.Entry<String, ?> entry : allEntries.entrySet()) {
            ...
            for (String detail : exerciseSet) {
                if (!detail.equals(exerciseName)) {
                    ...
                    } else if (detail.matches("-?\\d+.\\d+")) {
                        if (exerciseLatitude.isEmpty()) {
                            exerciseLatitude = detail;
                            exerciseInfo.append("Latitude: ").append(detail.substring(1)).append("\n");
                        } else {
                            exerciseInfo.append("Longitude: ").append(detail.substring(1)).append("\n");
                        }
                    } else {
